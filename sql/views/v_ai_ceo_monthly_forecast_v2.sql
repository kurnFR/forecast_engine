-- V2 CEO monthly forecast aggregation
-- Aggregates the authoritative regional targets and V2 regional forecasts.
-- No independent CEO forecasting model is applied.

CREATE OR REPLACE VIEW dwh_prod.v_ai_ceo_monthly_forecast_v2 AS
WITH aggregated AS (
    SELECT
        r.periode,
