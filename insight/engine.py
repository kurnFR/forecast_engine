...
- triggered_action_plan: exactly one short Indonesian management action supported by the facts. Base the action only on supplied forecast gap, working-day, focus/category, priority, and named shortfall-contributor facts. The action is a management response to the supplied facts, NOT a calculated sales-rate prescription.
