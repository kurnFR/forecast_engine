            ...
            if level == "REGION":
                ...
                conn.execute(
                    text("""
                        ...
                        (
                            ...
                            v2_achievement_pct_forecast,
                            v2_forecast_gap_to_target,
                            v2_forecast_uncertainty_pct,
                            v2_performance_scenario,
                            v2_performance_scenario_name,
                            v2_forecast_scenario,
                            v2_model_spread,
                            v2_model_spread_pct_p50,
                            v2_forecast_shortfall,
                    ...
                    """),
                    {
                        ...
                        "c": row["entity_code"],
                        "n": row["entity_name"],
                        "scenario": row["performance_scenario"],
                        "pri": row["priority"],
                        "target": row["target_sellin"],
                        "actual": row["mtd_actual"],
                        "p50": row["forecast_p50"],
                        "gap": row["forecast_gap_to_target"],
                        "diag": insight["ai_diagnosis"],
                        "action": insight["triggered_action_plan"],
                        "model": "hermes-bi-insight",
                        "prompt": "v2-forecast",
                        "p10": row["forecast_p10"],
                        "p90": row["forecast_p90"],
                        "ach": row["achievement_pct_forecast"],
                        "unc": row["forecast_uncertainty_pct"],
                        "psn": row["performance_scenario_name"],
                        "fs": row["forecast_scenario"],
                        "spread": row["model_spread"],
                        "spreadpct": row["model_spread_pct_p50"],
                        "shortfall": row["forecast_shortfall"],
                        "contrib": row["shortfall_contribution_pct"],
                        "category": insight["ai_insight_category"],
                    },
                )
                ...
                conn.execute(
                    text("""
                        ...
                        (
                            ...
                            v2_forecast_gap_to_target,
                            v2_forecast_uncertainty_pct,
                            v2_performance_scenario, v2_forecast_scenario,
                            v2_model_spread, v2_model_spread_pct_p50,
                            v2_forecast_shortfall,
                            v2_shortfall_contribution_pct,
                            v2_largest_shortfall_regioncode,
                            v2_largest_shortfall_regionname,
                            v2_largest_region_shortfall,
                            v2_largest_region_shortfall_pct,
                            v2_ai_insight_category
                        )
                        VALUES
                        (
                    ...
                    """),
                    {
                        ...
                        "shortfall": row["forecast_shortfall"],
                        "contrib": row["shortfall_contribution_pct"],
                        "lr": row["largest_shortfall_regioncode"],
                        "lrn": row["largest_shortfall_regionname"],
                        "ls": row["largest_region_shortfall"],
                ...
                conn.execute(
                    text("""
                        ...
                        SET is_active = 0
                        WHERE insight_type = 'CEO_SALES_SUMMARY'
                          AND is_active = 1
                    """)
                )
                conn.execute(
